...
export function StandardTasksTable({
  ...
  return (
    <>
      <div className="hidden grid-cols-[1fr_140px_200px_120px_100px] gap-4 border-b border-[#E5E9F0] bg-[#F9FAFB] px-6 py-3 text-xs font-semibold uppercase tracking-wide text-[#9AA3B2] md:grid">
      ...
      <div className="divide-y divide-[#E5E9F0]">
        {tasks.map((task) => (
          <div
            key={task.id}
            className="grid grid-cols-1 gap-3 px-6 py-4 md:grid-cols-[1fr_140px_200px_120px_100px] md:items-center md:gap-4"
          >
            <div>
